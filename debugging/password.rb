...
# The password variable was not visible inside the set password method in the original code. We therefore had to assign the return of
# this method to a variable and then pass this as an argument to the verify_password method
